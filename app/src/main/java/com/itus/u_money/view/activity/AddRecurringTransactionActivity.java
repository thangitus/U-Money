...
import com.itus.u_money.databinding.ActivityAddRecurringTransactionBinding;
...
public class AddRecurringTransactionActivity extends AppCompatActivity {
    ...
    ActivityAddRecurringTransactionBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityAddRecurringTransactionBinding.inflate(getLayoutInflater());
