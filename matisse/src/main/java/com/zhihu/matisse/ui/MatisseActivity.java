 ...
 */
public class MatisseActivity extends AppCompatActivity implements AlbumCollection.AlbumCallbacks, AdapterView.OnItemSelectedListener, MediaSelectionFragment.SelectionProvider, AlbumMediaAdapter.CheckStateListener, AlbumMediaAdapter.OnMediaClickListener, AlbumMediaAdapter.OnPhotoCapture {
   ...
   public void returnFileName(View view) {
      Intent result = new Intent();
      String path = mSelectedCollection.asListOfString()
                                       .get(0);
      result.putExtra("FilePath", path);
      setResult(RESULT_OK, result);
      finish();
   }
